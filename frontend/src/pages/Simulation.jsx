      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="bg-blue-50 rounded-lg p-4 mt-4">
          ...
          <ul className="text-sm text-blue-700 mt-2 space-y-1">
            ...
            <li>
              • Recommended overbooking: {data.recommendedOverbooking ?? "--"}%
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
          {!simulationResults && !error && (
            <div className="bg-slate-200 rounded-lg shadow p-6 text-center text-gray-500">
                ...
                <div className="mt-4">
                  ...
                  <ul className="text-sm text-gray-700 space-y-1">
                    <li>
                      ...
                      {(
                        simulationResults.predictedStats
                          ?.averageNoShowProbability * 100
                      ).toFixed(1)}
                      %
                    </li>
                    <li>
                      ...
                      {(
                        simulationResults.predictedStats
                          ?.medianNoShowProbability * 100
                      ).toFixed(1)}
                      %
                    </li>
                    <li>
                      High risk patients:{" "}
                      {simulationResults.predictedStats?.highRiskCount}
                    </li>
                    <li>
                      Medium risk patients:{" "}
                      {simulationResults.predictedStats?.mediumRiskCount}
                    </li>
                    <li>
                      Low risk patients:{" "}
                      {simulationResults.predictedStats?.lowRiskCount}
                    </li>
                  </ul>
                </div>
              </div>
